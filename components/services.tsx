...
const services = [
  {
    ...
    subtitle: "Viví tu espacio con más eficiencia",
    description:
      "Construcción en seco con steel frame para viviendas que superan los estándares de la obra tradicional. Mayor precisión en cada unión, eficiencia térmica superior y tiempos de obra significativamente más cortos. Tu hogar terminado antes, con menor desperdicio y mayor calidad.",
    features: [
      "Eficiencia térmica clase A",
      "Tiempos de obra reducidos 40%",
      "Precisión milimétrica en uniones",
      "Cero residuos de mampostería",
    ],
  ...
  },
  {
    ...
    icon: Briefcase,
    label: "Servicio 02",
    title: "Oficinas Anexas",
    subtitle: "Tu espacio de trabajo en tu casa",
    description:
      "Espacios de trabajo diseñados para integrarse de forma armónica con tu vivienda existente. Ampliaciones en steel frame que respetan la estética de tu hogar y te ofrecen un ambiente profesional sin moverte de donde vivís. Conectividad, aislación acústica y confort para trabajar en serio.",
    features: [
      "Integración perfecta con vivienda existente",
      "Aislación acústica profesional",
      "Instalaciones eléctricas de alta capacidad",
      "Personalización total de interiores",
    ],
    ...
    >
      ...
      >
        <FadeIn delay={0.1} direction={isReverse ? "left" : "right"}>
          ...
          <h3
            className="font-display font-bold leading-[0.92] tracking-[-0.025em] text-text-primary mb-3"
